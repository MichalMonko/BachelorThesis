...
class CameraSessionBuilder
{
    ...
    fun withListener(listener: CameraCaptureSession.CaptureCallback): CameraSessionBuilder
    {
    ...
    {
        return CameraAbstractionLayer(activity, callbackListener, this.targets)
    }
}
